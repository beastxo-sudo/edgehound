...
REQUIRED_TABS=()
REQUIRED_PANELS=("curve" "stats" "fillPanel" "bandsTable" "dailyTable" "recentBets" "endpoint" "vchain")
...
if grep -q 'strategy.json' /tmp/_live.html; then echo "✓ loads strategy digest"; else echo "✗ digest fetch missing"; fail=1; fi
